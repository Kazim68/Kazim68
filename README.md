...
|--------------|----------------------|
| **CS Student @ UET Lahore (2026)**  <br> **Full Stack Software Engineer** (Node.js, Python) &nbsp; &#124; &nbsp; AWS • REST APIs  <br><br> Solving real-world problems with scalable systems. <br> **Top LeetCoder** with 350+ problems solved. <br> Focused on **Cloud Infrastructure** & **Machine Learning**. | **Languages:** JavaScript (Node.js, React), Python (FastAPI), SQL, C++, C# <br> **Frameworks & Tools:** Express.js, Docker, Git, Postman, JIRA <br> **Cloud Platforms:** AWS (EC2, S3, CloudFront, Amplify) <br> **Databases:** MongoDB, MySQL, MSSQL, Redis <br> **Development Concepts:** REST APIs, RBAC, CI/CD, Agile, System Design <br> **ML / Data Tools:** Pandas, NumPy, Scikit-learn, OpenCV, Jupyter |
...
<p align="left"><i>"Building clean systems. Solving real problems. Learning endlessly."</i></p>
<p align="left"><strong>📫 Let's connect on <a href="https://www.linkedin.com/in/abdur-rehman-kazim" target="_blank">LinkedIn</a>.</strong></p>
